...
public class JobProjectController extends BaseController {
    ...
    public Result<IPage<JobProject>> selectAll(@RequestParam(value = "searchVal", required = false) String searchVal,
    ...
    @GetMapping("/list")
    public Result<List<JobProject>> selectList() {
    ...
    @GetMapping("{id}")
    public Result<JobProject> selectOne(@PathVariable Serializable id) {
    ...
    @PostMapping
    public Result<Boolean> insert(HttpServletRequest request, @RequestBody JobProject entity) {
    ...
    public Result<Boolean> update(@RequestBody JobProject entity) {
